...
var Visualizer = (function($, window, undefined) {
    ...
    var Visualizer = function(dispatcher, svgId, webFontURLs) {
      ...
      var highlightRounding = { x: 5, y:5 }; // rx, ry for highlight boxes
      var spaceWidths = {
        ' ': 4,
        '\u00a0': 4,
        '\u200b': 0,
      ...
      var arcSlant = 15; //10;
      var minArcSlant = 8;
      var arcHorizontalSpacing = 13; // min space boxes with connecting arc
      var rowSpacing = -2;          // for some funny reason approx. -10 gives "tight" packing.
      ...
      var rowPadding = 2;
      var nestingAdjustYStepSize = 10; // size of height adjust for nested/nesting spans
